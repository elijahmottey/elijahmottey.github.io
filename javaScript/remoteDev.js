...
// main
      ...
      <div class="employee-description">
              <div class="employee-data">
                  ...
                  <div class="apply">
                  <a href="/apply/html/applyID_5.html" target="_blank" >  <button class="button apply-1" >Apply Now</button></a>
                  </div>
      ...
      div.innerHTML=` 
          ...
          <div class="apply">
          <button class="button    footer-button"><a href="/apply/html/applyID_5.html">Apply Now</a></button>
          </div>
        </div>
